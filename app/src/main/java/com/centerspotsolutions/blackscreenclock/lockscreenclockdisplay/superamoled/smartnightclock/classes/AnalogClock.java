...
public class AnalogClock extends View {
    ...
    public void init(Context context, int i, int i2, int i3, int i4, int i5, boolean z, boolean z2) {
        ...
        Drawable drawable2 = getContext().getDrawable(i3);
        Drawable drawable3 = getContext().getDrawable(i4);
        this.mCalendar = Calendar.getInstance();
        this.mHandsDialOverlay = new HandsDialOverlay(drawable, drawable2, drawable3).withScale(this.sizeScale);
    }
